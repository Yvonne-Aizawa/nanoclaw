...
// These are imported here to avoid circular dependency issues since migrateJsonState
// needs them but they live in domain files that import `db` from this module.
// We define them inline here for the migration only.
